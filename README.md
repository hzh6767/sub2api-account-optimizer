...
仓库中的 [`patches/sub2api-0.1.141-optimizer.patch`](patches/sub2api-0.1.141-optimizer.patch)
基于以下版本生成：

- 上游项目：[Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api)
- 基线提交：`7cb98e5bdca776d643d284aa2f4ce7151308819e`
- 补丁提交：`6d321215b652ad607ecedc3cf11b9dfdecd0f020`
...
1. 确认 Sub2API 版本：
   ...
   cd /opt/sub2api
   git rev-parse HEAD
   # 预期基线：7cb98e5bdca776d643d284aa2f4ce7151308819e
   ```

2. 检查并应用补丁：

   ```sh
   git apply --check account-optimizer/patches/sub2api-0.1.141-optimizer.patch
   git apply account-optimizer/patches/sub2api-0.1.141-optimizer.patch
   docker build -t sub2api:0.1.141-account-optimizer .
   ```
